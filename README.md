...
- **[Awkward-Angle Tool Access](awkward-angle-tools.md)** - NEW: Comprehensive analysis of overcuts and tool marks appearing in ergonomically impossible positions on ancient hard-stone work. Examines the puzzle of precision features in locations inaccessible in the stone's final installed orientation—including Serapeum sarcophagi interiors (70-ton granite boxes with 5-micron flatness), Puma Punku H-block channels (1-2mm tolerance in 8-15cm spaces), Gal Vihara rock-cut Buddhas (14-meter sculptures with under-arm and deep fold details), Aswan quarry trenches (60-85cm wide, 2.5-4m deep), and Egyptian colossi details (between-leg channels, armpit features on 20-1,000 ton statues). Analyzes the rotation-during-fabrication hypothesis with evidence for and against, ergonomic workspace analysis, technical comparison tables across sites, time-motion labor estimates, and the persistent mysteries of how the cleanest overcuts were achieved in the most constrained positions.
...
- **[Inscription-Dating Problem](inscription-dating-problem.md)** - NEW: Systematic documentation of the methodological challenge of dating Egypt's most technically impressive precision work based on crude later inscriptions. Examines the observable pattern where the highest-precision hard-stone artifacts carry no integral Egyptian iconography, and where inscriptions do appear, they are visibly and technically inferior to the precision engineering. Covers six detailed case studies (Serapeum boxes, Valley Temple, Osireion, Great Pyramid granite, Predynastic vases, Sphinx), composite pattern tables comparing uninscribed precision work vs. inscribed dynastic work, analysis of circular dating methodology, connection to the global degradation pattern, and identification of a genuine research gap—no systematic published analysis of differential weathering or tool-marks between precision surfaces and inscription cuts exists. Establishes that predynastic precision (15-50µm) predates hieroglyphic writing entirely, proving precision came before inscriptions.
...
timeline
    ...
    1400-1200 BCE : Sacsayhuamán fortress (Peru)
